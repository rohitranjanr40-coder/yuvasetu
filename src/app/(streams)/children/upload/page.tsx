...
function UploadChildrenPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Upload Children's Video</CardTitle>
          <CardDescription>Share your fun and safe content for kids. Fill out the details below.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <Input id="title" placeholder="e.g., Fun with Shapes and Colors" value={title} onChange={(e) => setTitle(e.target.value)} disabled={isUploading} />
          </div>
          <div className="space-y-2">

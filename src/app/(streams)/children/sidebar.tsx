...
import { History, Archive, Baby, Rss } from "lucide-react";
...
export default function Sidebar() {
  ...
  const mainNavItems = [
    { href: "/children", icon: Baby, label: "Kids Hub" },
    { href: "/children/live", icon: Rss, label: "Live" },
  ];
  ...
  let libraryNavItems = [
    ...
    { href: "/children/bucket", icon: Archive, label: "Bucket" },
  ];

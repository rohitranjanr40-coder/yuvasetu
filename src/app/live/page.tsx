  ...
  useEffect(() => {
    async function fetchLiveVideos() {
      ...
      try {
        ...
        const activeLiveVideos = allVideos.filter(v => v.live);
  ...
  return (
    <div className="space-y-8">
        <div className="text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight font-headline mt-4">Live Hub</h1>
            <p className="mt-2 text-lg text-muted-foreground">
                See what's broadcasting right now across the platform.
            </p>
        </div>
        <Card>
            <CardHeader>
                <CardTitle>Broadcasting Now</CardTitle>
                <CardDescription>All active live streams.</CardDescription>
            </CardHeader>
            <CardContent>
                 {liveVideos.length > 0 ? (

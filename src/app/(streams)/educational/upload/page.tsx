...
function UploadEduPageContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Upload Edu Video</CardTitle>
          <CardDescription>Share your educational creation with the world. Fill out the details below.</CardDescription>
        </CardHeader>
